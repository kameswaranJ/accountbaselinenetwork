# TODO commented to test on non prod control tower
#resource "aws_route53_zone" "delegated" {
#  provider   = aws.app
#  count      = var.deploy_global_resources ? 1 : 0
#  depends_on = [module.shared_vpc, module.dedicated_vpc]
#
#  lifecycle {
#    ignore_changes = [
#      vpc
...
#
#  vpc {
#    vpc_id = local.all_vpcs[0]["vpc_id"]
#  }
#}
#
...
#  vpc_id  = local.all_vpcs[var.deploy_global_resources ? count.index + 1 : count.index]["vpc_id"]
#}
#
